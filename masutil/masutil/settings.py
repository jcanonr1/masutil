"""
Django settings for masutil project.
...
SECRET_KEY = 'django-insecure-izvdzn33mhx-b!v(5rsbfm!2vokd769^n0rk9!zdo1fji*=4e3'
...
WSGI_APPLICATION = 'masutil.wsgi.application'
...
#configuracion PARCIAL de email para gmail
